...
dotnet publish ..\src\DeskLLM.Avalonia\DeskLLM.Avalonia.csproj -c Release -r win-x64 --self-contained true -p:PublishSingleFile=true -o "%OUT%" || exit /b %errorlevel%

rem Rename output binary to deskLLM.exe if present
