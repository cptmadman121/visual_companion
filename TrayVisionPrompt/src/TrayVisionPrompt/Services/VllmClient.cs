...
public class VllmClient : OpenAiCompatibleClient
{
    private readonly AppConfiguration _configuration;

    public VllmClient(AppConfiguration configuration, ILogger logger)
    ...
    protected override object BuildPayload(LlmRequest request)
    {
        ...
        else if (!string.IsNullOrEmpty(request.OcrText))
        {
            content.Add(new Dictionary<string, object?>
            {
                ["type"] = "text",
